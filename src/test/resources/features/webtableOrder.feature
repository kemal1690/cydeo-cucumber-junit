Feature: Web table user order feature
  ...
  Scenario: User should be able to place order and order seen in web table
    ...
    #if there was no parameterization we would type every card type here in other lines start with And
  ...
  Scenario Template: User should be able to place order and order seen in web table
    ...
    And user enters quantity <quantity>
      #quantity is integer that is why it is not in the ""
    ...
    @femaleScientists
      #we can type that to the tag in CukesRunner
